...
import folderList from '../../db/invoice/folderList';
import {invoiceList, clientList, invoiceSettings} from '../../db/invoice';
...
// mock.onGet('/invoice/settings').reply(() => {
//   console.log('invoiceSettingsData', invoiceSettingsData);
//   return [200, invoiceSettingsData];
// });

mock.onGet('/invoice/settings').reply(200, invoiceSettingsData);
