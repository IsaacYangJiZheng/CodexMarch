 ...
 * @param {string|Array|Object} structure.userRole - [Optional] in order to differentiate between admin and normal users * @param {object} [structure.anonymousStructure] - it's an object that has only [ routes ] array, [ these routes available for All personas ]
...
* userRole: string|Array|Object -----> To override route props
