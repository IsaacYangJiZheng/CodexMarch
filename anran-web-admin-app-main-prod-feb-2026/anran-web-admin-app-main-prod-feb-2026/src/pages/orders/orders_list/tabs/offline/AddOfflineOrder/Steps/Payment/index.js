...
const MemberPayments = () => {
  ...
  React.useEffect(() => {
    ...
    setPayMethodList(clonedArray);
    setSelectedMethod([{ id: null, name: '', amount: '', reference: selectedBranch?.branchName || '', uuid: uuidv4() }]); // Set default reference to branchName
  }, []);
            ...
            <AppDialog
              ...
              title={
                <CardHeader
                  ...
                  title={formatMessage({id: 'finance.sales.payment.confirmOrderTitle'})}
                />
              }
            >
