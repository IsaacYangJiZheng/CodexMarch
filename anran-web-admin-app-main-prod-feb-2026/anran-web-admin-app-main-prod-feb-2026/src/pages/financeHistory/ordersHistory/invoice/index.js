                ...
                <Grid container spacing={2} style={{marginTop: '20px'}}>
                  <Grid size={{xs: 12, md: 8}}>
                    ...
                    {dayjs(invoiceData.orderDate).isSameOrAfter('2025-08-01', 'day') && (
                      <Grid>
                        <Typography variant='caption' sx={{fontSize: '20px'}}>
                          <strong>Package Expiry.</strong> Please note that this 
                          package is valid for a period of one (1) year commencing 
                          from the first date of usage. Any unused sessions beyond 
                          this period will be forfeited without refund.
                        </Typography>
                      </Grid>
                    )}
                  </Grid>
