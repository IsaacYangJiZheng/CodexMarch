...
const CreateVoucher = ({open, onClose, reCallAPI}) => {
      ...
      <AppDialog
        ...
        title={
          <CardHeader
            ...
            title={formatMessage({id: 'admin.voucher.create.title'})}
          />
        }
      >
        <Formik
          ...
          onSubmit={async (values, {setSubmitting}) => {
            ...
            try {
              ...
              infoViewActionsContext.showMessage(
                formatMessage({id: 'admin.voucher.create.success'}),
              );
            } catch (error) {
              ...
              <Grid container spacing={2}>
                ...
                {/* <Grid item xs={6} md={6}>
                  <AppTextField
                    ...
                    margin='dense'
                    type='text'
                    helperText={<ErrorMessage name='voucherName' />}
                  />
                </Grid> */}
                <Grid size={6}>
                  <AppTextField
...
CreateVoucher.propTypes = {
  ...
  voucherDatabase: PropTypes.arrayOf(
    PropTypes.shape({
