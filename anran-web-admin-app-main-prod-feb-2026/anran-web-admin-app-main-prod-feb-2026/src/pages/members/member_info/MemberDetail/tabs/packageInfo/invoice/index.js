...
const InvoicePage = ({invoiceId}) => {
  ...
  const [{apiData, loading}] = useGetDataApi(
    `api/order/full-detail/${invoiceId}`,
    //undefined,
    {},
    {},
    true,
  ...
  //     // const {data} = await jwtAxios.post('email/send-pdf', {data: fd});
  //     // var res = pdf.output('datauristring');
  //     // const {data} = await jwtAxios.post('email/send-pdf', res);
  //     // if (data.status) {
                ...
                <Container>
                      ...
                      <Table size='small'>
                        <TableBody>
                          ...
                          <TableRow>
                            ...
                            >
                              {dayjs(invoiceData.orderDate).format(
                                'DD/MM/YYYY',
                              )}
                            </TableCell>
                          </TableRow>
                  ...
                  <Grid container style={{marginTop: '20px'}} spacing={2}>
                    ...
                    <Grid size={{xs: 12}}>
                      ...
                      <Typography sx={{fontSize: '20px'}}>
                        <strong>
                          {invoiceData.branch.branchContactNumber}
                        </strong>
                      </Typography>
                    </Grid>
                  </Grid>
                    ...
                    <Grid size={{xs: 12, md: 8}}>
                      ...
                      <Grid>
                        <Typography variant='caption' sx={{fontSize: '20px'}}>
                          ...
                          claims regarding the invoice must be made within 7
                      ...
                      <Grid>
                        <Typography variant='caption' sx={{fontSize: '20px'}}>
                          <strong>Taxes and Duties.</strong> All prices quoted
                          are exclusive of governmental tax charges.
                        </Typography>
                      </Grid>
                    </Grid>
                        ...
                        <TableBody>
                          ...
                          <TableRow>
                            <TableCell
                              ...
                              align='right'
                            >
                              <strong>Sales and services tax:</strong>
                            </TableCell>
                            <TableCell
                              sx={{
                                padding: '5px',
                  ...
                  >
                    <Grid item xs={12} align='center'>
                      ...
                      <Typography variant='body1'>
                        (Previously known as ANRAN NAMI WELLNESS CENTRE
                        (HOLDINGS) SDN. BHD.)
                      </Typography>
                      <Typography variant='body1'>
