            ...
            <Table size='small'>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>
                    <strong>{formatMessage({id: 'member.invoice.description'})}</strong>
                  </TableCell>
                  <TableCell>
                    <strong>{formatMessage({id: 'member.invoice.qty'})}</strong>
                  </TableCell>
                  <TableCell>
                    <strong>{formatMessage({id: 'member.invoice.unitPrice'})}</strong>
                  </TableCell>
                  <TableCell>
            ...
            <Grid item xs={12} md={3} align='right'>
              <Table size='small'>
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell sx={{padding: '5px'}} align='right'>
                      <strong>{formatMessage({id: 'member.invoice.taxRate'})}</strong>
                    </TableCell>
                    <TableCell sx={{padding: '5px'}}>
                      {invoiceData.taxRate}
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell sx={{padding: '5px'}} align='right'>
                      <strong>{formatMessage({id: 'member.invoice.salesTax'})}</strong>
                    </TableCell>
                    <TableCell sx={{padding: '5px'}}>
